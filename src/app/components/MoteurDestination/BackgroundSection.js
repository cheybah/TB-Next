...
const BackgroundSection = async({ region }) => {
    ...
    return (
        ...
        <div className="px-4 mx-auto max-w-screen-xl py-24 lg:py-56 ">
            <span className="absolute  hidden sm:block titre  flex top-20 sm:top-28 lg:top-24 md:top-20 text-white   md:text-left text-[24px] sm:text-[38px] lg:text-[48px] font-semibold leading-[32px] sm:leading-[59px] opacity-100 w-[80%] sm:w-3/4 sm:px-0 md:top-20 md:w-4/5"
