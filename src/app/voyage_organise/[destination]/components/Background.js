...
const Background = () => {
    return (
        <section className="w-full bg-no-repeat bg-cover bg-[url('/img_moteur_home2-min.jpg')] bg-blend-multiply lg:h-[328px] sm:h-[500px] mb-[1rem] md:mb-[2rem] lg:mb-[5rem]" 
        alt="Tunisiebooking background" >
